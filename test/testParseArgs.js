...
describe('parseArgs', () => {
  it('should give fileName and default count', () => {
    assert.deepStrictEqual(parseArgs(['a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 10 } });
  });
  it('should return options and fileName', () => {
    assert.deepStrictEqual(parseArgs(['-n', '5', 'a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 5 } });
  });
  ...
  it('should accept multiple files and single option', () => {
    assert.deepStrictEqual(parseArgs(['-n', '5', 'a.txt', 'b.txt']), { files: ['a.txt', 'b.txt'], option: { flag: '-n', countBy: 'count', value: 5 } });
  });
  it('should work for options without spaces', () => {
    assert.deepStrictEqual(parseArgs(['-n5', 'a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 5 } });
  });
  it('option is count if option does not have key', () => {
    assert.deepStrictEqual(parseArgs(['-4', 'a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 4 } });
  });
...
describe('parseWithOption', () => {
  it('should give count option when -n is specified', () => {
    assert.deepStrictEqual(parseWithOption(['-n', '5', 'a.txt', 'b.txt']), { files: ['a.txt', 'b.txt'], option: { flag: '-n', countBy: 'count', value: 5 } });
  });
  ...
  it('should overWrite option if repeated', () => {
    assert.deepStrictEqual(parseWithOption(['-n', '5', '-n', '2', 'a.txt', 'b.txt']), { files: ['a.txt', 'b.txt'], option: { flag: '-n', countBy: 'count', value: 2 } });
  });
  it('should overWrite option if repeated in other formats also', () => {
    assert.deepStrictEqual(parseWithOption(['-n', '5', '-n2', 'a.txt', 'b.txt']), { files: ['a.txt', 'b.txt'], option: { flag: '-n', countBy: 'count', value: 2 } });
  });
  it('should work for options without spaces', () => {
    assert.deepStrictEqual(parseWithOption(['-n5', 'a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 5 } });
  });
  it('option is count if option does not have key', () => {
    assert.deepStrictEqual(parseWithOption(['-4', 'a.txt']), { files: ['a.txt'], option: { flag: '-n', countBy: 'count', value: 4 } });
  });
...
describe('defaultOption', () => {
  it('should give count:10 as defult option', () => {
    assert.deepStrictEqual(defaultOption(['a.txt', 'b.txt']), { files: ['a.txt', 'b.txt'], option: { flag: '-n', countBy: 'count', value: 10 } });
  });
});
...
describe('fetchOptions', () => {
  it('should give all options in arguments', () => {
    const expected = {
      files: ['a.txt', 'b.txt'],
      options: [{ flag: '-n', countBy: 'count', value: 5 },
      { flag: '-n', countBy: 'count', value: 4 },
      { flag: '-n', countBy: 'count', value: 5 }]
    };
...
describe('constructOption', () => {
  it('should contruct option with given values', () => {
    assert.deepStrictEqual(constructOption('-n', '2'), { flag: '-n', countBy: 'count', value: 2 });
...
describe('destructureOption', () => {
  it('should contruct option of given key', () => {
    assert.deepStrictEqual(destructureOption('-n1'), { flag: '-n', countBy: 'count', value: 1 });
  ...
  it('should contstruct count option if key is not specified', () => {
    assert.deepStrictEqual(destructureOption('-7'), { flag: '-n', countBy: 'count', value: 7 });
  });
});
